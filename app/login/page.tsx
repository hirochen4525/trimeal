      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">メールアドレスまたはLINEでログインできます</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            {/* LINE Login Button */}
            <Button onClick={handleLineLogin} className="w-full bg-[#00B900] hover:bg-[#00A000] text-white" size="lg">
